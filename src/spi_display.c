...
static void display_send_cmd(lv_display_t *disp, const uint8_t *cmd,
...
static void display_send_color(lv_display_t *disp, const uint8_t *cmd,
...
void display_init(void) {
  ...
  lv_display_t *disp = lv_st7796_create(LCD_WIDTH, LCD_HEIGHT, LV_LCD_FLAG_NONE,
                                        display_send_cmd, display_send_color);
