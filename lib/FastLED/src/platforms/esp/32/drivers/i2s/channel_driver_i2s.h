...
/// ## Usage Example
/// ```cpp
/// // ChannelEngineI2S uses the IChannelDriver interface
/// CRGB leds[100];
/// void setup() {
///     FastLED.addLeds<WS2812, 1, GRB>(leds, 100);  // GPIO 1
///     // I2S driver auto-selected on ESP32-S3
/// }
///
/// void loop() {
...
/// @brief I2S LCD_CAM-based channel driver for parallel LED control on ESP32-S3
///
/// Implements IChannelDriver interface using ESP32-S3 LCD_CAM peripheral for
...
/// ```
class ChannelEngineI2S : public IChannelDriver {
public:
...
/// @brief Factory function to create I2S driver with real hardware peripheral
