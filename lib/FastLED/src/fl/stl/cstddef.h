...
// Avoid declaring size_t / ptrdiff_t in the global namespace.
// FastLED already provides these through fl/stl/stdint.h, and repeating typedefs
// is ill-formed in C++ even when the underlying types match.
